...
class Record(BaseModel):
    ...
    status = Column(SQLEnum(RecordStatus, values_callable=lambda x: [e.value for e in x]), default=RecordStatus.DRAFT, index=True)
    record_type = Column(SQLEnum(RecordType, values_callable=lambda x: [e.value for e in x]), default=RecordType.NOTE, index=True)
